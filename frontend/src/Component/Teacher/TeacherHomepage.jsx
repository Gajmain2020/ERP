...
function TeacherHomepage({ token }) {
  ...
  return (
    <Wrapper>
      <Heading>Welcome Teacher</Heading>
      {/* Time compoent */}
      <div className="flex justify-end items-center ">
        <span className="border truncate flex gap-3 px-4 py-1bg-gray-300/40 text-zinc-200 rounded-lg font-sub">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="grid gap-5 lg:grid-cols-3 md:grid-cols-2 xs:grid-cols-1 sm:grid-cols-1 bg-zinc-200/50 p-3 rounded-md text-lg">
          ...
          <div className="flex gap-2 ">
            <span className=" font-semibold">Emp Id:</span> {data.empId}
          </div>
          <div className="flex gap-2 ">
            <span className=" font-semibold">Email:</span> {data.email}
          </div>
          <div className="flex gap-2 ">
            <span className=" font-semibold">Ph. Number:</span>{" "}
            {data.phoneNumber}
          </div>
          <div className="flex gap-2 ">
